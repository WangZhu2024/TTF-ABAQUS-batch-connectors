...
name_part=['anchor-50-1',
           'anchor-50-1-lin-2-1',
           'anchor-50-1-rad-4',
           'anchor-50-1-lin-2-1-rad-4',
           'anchor-50-1-rad-3',
           'anchor-50-1-lin-2-1-rad-3',
           'anchor-50-1-rad-2',
           'anchor-50-1-lin-2-1-rad-2']                                         ############All names of the anchors in Assembly model

#Important Note: the order of the names must be consistent with the txt files, 
# i.e., anchor1.txt correspond to part instance "anchor-50-1";
#       anchor2.txt correspond to part instance "anchor-50-1-lin-2-1";
...
my_data = np.loadtxt('F:\\xt\\Desktop\\TTF_depth50\\'+name_txt+'.txt')        #the path & the name of the txt file
