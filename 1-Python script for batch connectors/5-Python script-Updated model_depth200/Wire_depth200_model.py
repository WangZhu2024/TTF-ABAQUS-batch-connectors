...
name_part=['maogan-200-1',
           'maogan-200-1-lin-2-1',
           'maogan-200-1-rad-4',
           'maogan-200-1-lin-2-1-rad-4',
           'maogan-200-1-rad-3',
           'maogan-200-1-lin-2-1-rad-3',
           'maogan-200-1-rad-2',
           'maogan-200-1-lin-2-1-rad-2']                                         ############All names of the anchors in Assembly model

#Important Note: the order of the names must be consistent with the txt files, 
# i.e., anchor1.txt correspond to part instance "anchor-200-1";
#       anchor2.txt correspond to part instance "anchor-200-1-lin-2-1";
...
my_data = np.loadtxt('F:\\xt\\Desktop\\TTF_depth200\\'+name_txt+'.txt')        #the path & the name of the txt file
