...
name_part=['anchor-100-1',
           'anchor-100-1-lin-2-1',
           'anchor-100-1-rad-4',
           'anchor-100-1-lin-2-1-rad-4',
           'anchor-100-1-rad-3',
           'anchor-100-1-lin-2-1-rad-3',
           'anchor-100-1-rad-2',
           'anchor-100-1-lin-2-1-rad-2']                                         ############All names of the anchors in Assembly model

#Important Note: the order of the names must be consistent with the txt files, 
# i.e., anchor1.txt correspond to part instance "anchor-100-1";
#       anchor2.txt correspond to part instance "anchor-100-1-lin-2-1";

num_part=str(str(getInput('name of txt file')))                          ##### The serial number of a txt file.
Part_sub=name_part[int(num_part)-1]                                      # Part_sub='anchor-1' 
...
my_data = np.loadtxt('F:\\xt\\Desktop\\TTF_depth100\\'+name_txt+'.txt')        #the path & the name of the txt file
